...
class LogisticRegressionGD(object):
    """Logistic Regression classifer with Gradient Decent.
    ...
    def fit(self, X, y):
        ...
        for i in range(self.n_iter):
            ...
            # this is the logistic 'cost' function defined on page 67.
...
# this is an artifact from when I copied over a class file to create this file.
# I don't know exactly what to do with it, and it might be used later in the textbook.
